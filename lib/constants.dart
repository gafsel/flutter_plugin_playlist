...
class RmxAudioErrorType {
  static const RMXERR_NONE_ACTIVE = 0;
  static const RMXERR_ABORTED = 1;
  static const RMXERR_NETWORK = 2;
  static const RMXERR_DECODE = 3;
  static const RMXERR_NONE_SUPPORTED = 4;
}
...
class RmxAudioStatusMessage {
  ...
  static const RMXSTATUS_PAUSE = 35;

  /// Reports a change in the reported track's playback position.
  static const RMXSTATUS_PLAYBACK_POSITION = 40;
  ...
  static const RMXSTATUS_SEEK = 45;

  /// The reported track has completed playback.
  static const RMXSTATUS_COMPLETED = 50;
  ...
  static const RMX_STATUS_SKIP_FORWARD = 90;

  /// The playlist has skipped back to the previous track.
  /// On both Android and iOS, this will be raised if the notification controls/Command Center were used to skip.
  /// It is unlikely you need to consume this event: RMXSTATUS_TRACK_CHANGED is also reported when this occurs,
  /// so you can generalize your track change handling in one place.
  static const RMX_STATUS_SKIP_BACK = 95;
  ...
  static const RMXSTATUS_TRACK_CHANGED = 100;
  ...
  static const RMXSTATUS_PLAYLIST_COMPLETED = 105;
  ...
  static const RMXSTATUS_ITEM_ADDED = 110;
